...
public class AddressBookParserTest {
    ...
    public void parseCommand_clearTasks() throws Exception {
        ClearTasksCommand command = (ClearTasksCommand) parser.parseCommand(
                ClearTasksCommand.COMMAND_WORD + " n/John Doe");
        assertEquals(new ClearTasksCommand("John Doe"), command);
    }
