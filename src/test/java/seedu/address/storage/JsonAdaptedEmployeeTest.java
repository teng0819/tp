...
public class JsonAdaptedEmployeeTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedEmployee person =
                new JsonAdaptedEmployee(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedEmployee person =
                new JsonAdaptedEmployee(null, VALID_PHONE, VALID_EMAIL, VALID_DEPARTMENT, VALID_POSITION,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedEmployee person =
                new JsonAdaptedEmployee(VALID_NAME, INVALID_PHONE, VALID_EMAIL,
                        VALID_DEPARTMENT, VALID_POSITION, VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedEmployee person =
                new JsonAdaptedEmployee(VALID_NAME, null, VALID_EMAIL, VALID_DEPARTMENT, VALID_POSITION,
                        VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedEmployee person =
                new JsonAdaptedEmployee(VALID_NAME, VALID_PHONE, INVALID_EMAIL,
                        VALID_DEPARTMENT, VALID_POSITION, VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedEmployee person =
                new JsonAdaptedEmployee(VALID_NAME, VALID_PHONE, null, VALID_DEPARTMENT,
                        VALID_POSITION, VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_nullPosition_throwsIllegalValueException() {
        JsonAdaptedEmployee person =
                new JsonAdaptedEmployee(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_DEPARTMENT,
